...
const config = {
  ...
  //BotName
  inviteLink:
    "https://discord.com/api/oauth2/authorize?client_id=1041284784955068467&permissions=8&scope=bot%20applications.commands",
  //BotInvite Link
  Features: [
    {
      name: "Moderation",
  ...
  //Bot Features
  serverCount: 12.000, //-  - Your
  memberCount: 42.000, //--   - Bot
  executedCommand: 50.000, //--  - Stats
  availableCommand: 35.000, //---   - Here
  //Do not change if you don't know about them
  faceBookLogo: (
    <BsFacebook className="h-10 w-10 text-[#4267B2] hover:scale-125 easeIn cursor-pointer" />
  ),
  discordLogo: (
    <FaDiscord className="h-10 w-10 text-[#738adb] hovaer:scale-125 easeIn cursor-pointer" />
  ),
  youTubeLogo: (
  ...
  twitterLink: "https://twitter.com/YwsfRshad",
  mediumLink: "https://medium.com/@anashoshorashad",
